...
This is the substrate for the Repository classes in :mod:`yumi.core.features.memory.repos`.
The :class:`~yumi.core.features.memory.memory.Memory` façade keeps the legacy
