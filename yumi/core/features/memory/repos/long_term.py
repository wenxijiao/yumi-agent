...
from yumi.core.features.memory.models import LONG_TERM_MEMORY_KINDS, LONG_TERM_TABLE, decode_json_list, encode_json
from yumi.core.features.memory.storage import add_row, query_rows, replace_row
...
class LongTermMemoryRepository:
    ...
    def _memory_facade(self):
        """Return an object compatible with :mod:`yumi.core.features.memory.storage` shims.
...
class _BackendAdapter:
    ...
    The helpers in :mod:`yumi.core.features.memory.storage` were written when there
