...
_DEFAULT_SCHEDULES_PATH = Path.home() / ".yumi" / "schedules.json"
...
class SchedulerService:
    ...
    :mod:`yumi.core.features.proactive.scheduler` and is wired in via
...
# registered by reference (yumi/tools/bootstrap.py), so they stay importable
