...
public final class Auth {
    ...
    private static final String TOKEN_PREFIX = "yumi_";
    private static final String LAN_TOKEN_PREFIX = "yumi-lan_";
    private static final String[] LEGACY_LAN_PREFIXES = {"ml1_", "yumi_lan_"};
    ...
    /**
     * Decode a {@code yumi-lan_} token into host and port.
     */
    public static String[] decodeLanCode(String token) {
        ...
        if (token.startsWith(LAN_TOKEN_PREFIX)) {
            ...
            if (encoded == null) {
                throw new IllegalArgumentException("Invalid Yumi LAN code prefix.");
            }
        }
    ...
    /**
     * Decode a {@code yumi_} relay credential token.
     */
    public static JsonObject decodeCredential(String token) {
        if (!token.startsWith(TOKEN_PREFIX)) {
            throw new IllegalArgumentException("Invalid Yumi credential prefix.");
        }
