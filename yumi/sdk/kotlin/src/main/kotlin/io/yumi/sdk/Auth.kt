...
private const val TOKEN_PREFIX = "yumi_"
private const val LAN_TOKEN_PREFIX = "yumi-lan_"
private val LEGACY_LAN_PREFIXES = arrayOf("ml1_", "yumi_lan_")
...
fun parseLanCodeToServerUrl(code: String): String {
    val encoded = when {
        code.startsWith(LAN_TOKEN_PREFIX) -> code.substring(LAN_TOKEN_PREFIX.length)
            ...
            e ?: throw IllegalArgumentException("invalid Yumi LAN code prefix")
        }
    }
