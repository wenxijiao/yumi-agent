...
Wraps Picovoice Porcupine. The user trains "hi kumi" at console.picovoice.ai
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError("pvporcupine is not installed. Install with: pip install kumi-agent[voice]") from exc
        import pvporcupine
        ...
        if keyword_path and keyword_path.strip():
            ...
            # Fallback to a built-in keyword. "hi kumi" is not built in;
