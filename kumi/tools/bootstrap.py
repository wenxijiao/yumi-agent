...
def init_kumi() -> None:
    ...
    register_tool(
        read_file,
        (
            "Read a local file on the Kumi server and return its text (or extracted text for PDF/DOCX). "
            "Whenever the user message contains an absolute path—especially under `.kumi/uploads/`—"
