"""Kumi SDK integration for the Planner (schedule) demo."""

from __future__ import annotations

from kumi.demo.planner.app import (
    add_event,
    clear_schedule,
    get_schedule,
    remove_event,
...
def init_kumi(connection_code: str | None = None) -> KumiAgent:
    agent = KumiAgent(connection_code=connection_code, edge_name="Planner-Demo")
