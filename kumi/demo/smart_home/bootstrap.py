"""
Kumi SDK integration for the Smart Home demo.

Registers application tools with ``KumiAgent`` — same pattern as a real app.
"""

from __future__ import annotations

from kumi.demo.smart_home.app import (
    brew_coffee,
    set_alarm,
    set_curtains,
    set_door_lock,
...
def init_kumi(connection_code: str | None = None) -> KumiAgent:
    agent = KumiAgent(connection_code=connection_code, edge_name="SmartHome-Demo")
