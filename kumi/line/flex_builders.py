...
Postback ``data`` max 300 chars: ``kumi|<verb>|<short_id>|<arg>``
"""
...
POSTBACK_PREFIX = "kumi"
MAX_POSTBACK_LEN = 300

# Compact postback verbs: ``kumi|<verb>|<short_id>|<arg>`` (LINE data <= 300 chars).
...
def flex_size_bytes(contents: dict[str, Any], alt_text: str = ".") -> int:
    from kumi.line.client import flex_message
