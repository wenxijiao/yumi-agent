...
static const FString TokenPrefix = TEXT("kumi_");
static const FString LanTokenPrefix = TEXT("kumi-lan_");
static const FString LegacyLanPrefixes[] = { TEXT("ml1_"), TEXT("kumi_lan_") };
...
FLanCodeResult DecodeLanCode(const FString& Token)
{
    ...
    else
    {
        ...
        if (!bMatched)
        {
            UE_LOG(LogTemp, Error, TEXT("[Kumi] Invalid LAN code prefix."));
            return {};
        }
    }
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("[Kumi] Failed to parse LAN code JSON."));
        return {};
    }
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("[Kumi] LAN code missing host."));
        return {};
    }
    ...
    if (JsonObj->HasField(TEXT("x")))
    {
        ...
        if (Expiry != 0)
        {
            ...
            if (Expiry < Now)
            {
                UE_LOG(LogTemp, Error, TEXT("[Kumi] LAN code has expired."));
                return {};
            }
        }
    }
...
TSharedPtr<FJsonObject> DecodeCredential(const FString& Token)
{
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("[Kumi] Invalid credential prefix."));
        return nullptr;
    }
...
)
{
    ...
    Request->OnProcessRequestComplete().BindLambda(
        [CapturedRelayUrl, OnComplete](FHttpRequestPtr, FHttpResponsePtr Response, bool bSuccess)
        {
            ...
            {
                UE_LOG(LogTemp, Error, TEXT("[Kumi] Bootstrap failed."));
                OnComplete({});
                return;
            }
