...
from kumi.core.memories.models import LONG_TERM_MEMORY_KINDS, LONG_TERM_TABLE, decode_json_list, encode_json
from kumi.core.memories.storage import add_row, query_rows, replace_row
...
class LongTermMemoryRepository:
    ...
    def _memory_facade(self):
        """Return an object compatible with :mod:`kumi.core.memories.storage` shims.
...
class _BackendAdapter:
    """Minimal duck-type for ``kumi.core.memories.storage``'s memory parameter.

    The helpers in :mod:`kumi.core.memories.storage` were written when there
