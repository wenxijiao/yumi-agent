...
(see :mod:`kumi.core.memories.backend`, :mod:`kumi.core.memories.embedding_runner`,
:mod:`kumi.core.memories.repos`). This module keeps the historical
...
* Legacy private methods used by external callers (``_has_table``,
  ...
  collaborator so :mod:`kumi.core.memories.context`,
  :mod:`kumi.core.memories.storage` and :mod:`kumi.core.memories.writer`
  keep functioning unchanged.

What moved
----------
* LanceDB connection, time/SQL helpers → :class:`~kumi.core.memories.backend.LanceDBBackend`
* Embedding state, dim migration, re-embed → :class:`~kumi.core.memories.embedding_runner.EmbeddingProcessor`
* Per-table CRUD → repositories under :mod:`kumi.core.memories.repos`
"""

from __future__ import annotations

from kumi.core.config import load_model_config, migrate_legacy_memory_dir
from kumi.core.memories import transcript as _transcript
from kumi.core.memories.backend import LanceDBBackend
from kumi.core.memories.constants import DELETED_SESSION_STATUS
from kumi.core.memories.embedding_runner import EmbeddingProcessor
from kumi.core.memories.embedding_state import (
    get_embed_provider,
)
from kumi.core.memories.embedding_state import (
    is_degenerate_vector as _is_degenerate_vector,  # noqa: F401 — re-exported for legacy callers
)
from kumi.core.memories.models import (
    LONG_TERM_TABLE,
    SESSION_SUMMARY_TABLE,
    TOOL_OBSERVATION_TABLE,
)
from kumi.core.memories.repos import (
...
from kumi.core.memories.tool_replay import persist_openai_messages as _tool_replay_persist
from kumi.core.prompts.store import get_effective_system_prompt
...
class Memory:
    ...
    def __init__(self, session_id: str = "default", system_prompt=None, storage_dir=None, max_recent: int = 10):
        ...
        # ``kumi.core.prompts.set_session_prompt``. The argument stays so the
    ...
    def persist_openai_messages(self, messages: list[dict]) -> None:
        ...
        try:
            from kumi.core.memories.writer import MemoryWriter
    ...
    def get_context(
        ...
        from kumi.core.memories.context import ContextBuilder
    ...
    def _search_structured_table(
        ...
        *,
        ...
        from kumi.core.memories.repos.long_term import _BackendAdapter
        from kumi.core.memories.storage import query_rows
        ...
        from kumi.core.memories.retrieval import keyword_score
