...
:mod:`kumi.core.plugins.single_user` and ship with OSS so the codebase
...
from kumi.core.plugins.discovery import (
    ENTRY_POINT_GROUP,
    load_entry_point_plugins,
    load_plugin_module,
)
from kumi.core.plugins.identity import (
    LOCAL_IDENTITY,
    SINGLE_USER_ID,
    SINGLE_USER_TENANT,
    Identity,
...
from kumi.core.plugins.registry import (
    get_admin_cli,
    get_audit_sink,
    get_billing_hook,
    get_bot_pool,
