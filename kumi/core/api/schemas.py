"""Pydantic request/response models for the Kumi HTTP API."""
...
class ModelConfigUpdateRequest(BaseModel):
    ...
    # Stored in ~/.kumi/config.json; omit or leave empty to keep existing value.
...
class ChatDebugRequest(BaseModel):
    """Enable or disable NDJSON chat tracing for a session (writes under ~/.kumi/debug/chat_trace/)."""
