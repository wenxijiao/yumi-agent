"""Filesystem paths for Kumi config and LanceDB memory storage."""

import shutil
from pathlib import Path

CONFIG_DIR = Path.home() / ".kumi"
CONFIG_PATH = CONFIG_DIR / "config.json"
MEMORY_DIR = CONFIG_DIR / "memory"
# Legacy bundled DB shipped under kumi/core/memories/.lancedb (kumi/core is parent of this config/ dir).
