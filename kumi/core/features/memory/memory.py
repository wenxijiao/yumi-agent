...
(see :mod:`kumi.core.features.memory.backend`, :mod:`kumi.core.features.memory.embedding_runner`,
:mod:`kumi.core.features.memory.repos`). This module keeps the historical
...
* Legacy private methods used by external callers (``_has_table``,
  ...
  collaborator so :mod:`kumi.core.features.memory.context`,
  :mod:`kumi.core.features.memory.storage` and :mod:`kumi.core.features.memory.writer`
  keep functioning unchanged.

What moved
----------
* LanceDB connection, time/SQL helpers → :class:`~kumi.core.features.memory.backend.LanceDBBackend`
* Embedding state, dim migration, re-embed → :class:`~kumi.core.features.memory.embedding_runner.EmbeddingProcessor`
* Per-table CRUD → repositories under :mod:`kumi.core.features.memory.repos`
"""

from __future__ import annotations

from kumi.core.features.config import load_model_config, migrate_legacy_memory_dir
from kumi.core.features.memory import transcript as _transcript
from kumi.core.features.memory.backend import LanceDBBackend
from kumi.core.features.memory.constants import DELETED_SESSION_STATUS
from kumi.core.features.memory.embedding_runner import EmbeddingProcessor
from kumi.core.features.memory.embedding_state import (
    get_embed_provider,
)
from kumi.core.features.memory.embedding_state import (
    is_degenerate_vector as _is_degenerate_vector,  # noqa: F401 — re-exported for legacy callers
)
from kumi.core.features.memory.models import (
    LONG_TERM_TABLE,
    SESSION_SUMMARY_TABLE,
    TOOL_OBSERVATION_TABLE,
)
from kumi.core.features.memory.repos import (
...
from kumi.core.features.memory.tool_replay import persist_openai_messages as _tool_replay_persist
from kumi.core.features.prompts.store import get_effective_system_prompt
...
class Memory:
    ...
    def __init__(self, session_id: str = "default", system_prompt=None, storage_dir=None, max_recent: int = 10):
        ...
        # ``kumi.core.features.prompts.set_session_prompt``. The argument stays so the
    ...
    def persist_openai_messages(self, messages: list[dict]) -> None:
        ...
        try:
            from kumi.core.features.memory.writer import MemoryWriter
    ...
    def get_context(
        ...
        from kumi.core.features.memory.context import ContextBuilder
    ...
    def _search_structured_table(
        ...
        *,
        ...
        from kumi.core.features.memory.storage import query_rows
        ...
        from kumi.core.features.memory.retrieval import keyword_score
