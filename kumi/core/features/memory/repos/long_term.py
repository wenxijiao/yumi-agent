...
from kumi.core.features.memory.models import LONG_TERM_MEMORY_KINDS, LONG_TERM_TABLE, decode_json_list, encode_json
from kumi.core.features.memory.storage import add_row, query_rows, replace_row
...
class LongTermMemoryRepository:
    ...
    def _memory_facade(self):
        """Return an object compatible with :mod:`kumi.core.features.memory.storage` shims.
...
class _BackendAdapter:
    """Minimal duck-type for ``kumi.core.features.memory.storage``'s memory parameter.

    The helpers in :mod:`kumi.core.features.memory.storage` were written when there
