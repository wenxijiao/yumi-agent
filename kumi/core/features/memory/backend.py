...
This is the substrate for the Repository classes in :mod:`kumi.core.features.memory.repos`.
The :class:`~kumi.core.features.memory.memory.Memory` façade keeps the legacy
