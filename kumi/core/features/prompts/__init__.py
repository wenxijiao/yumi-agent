...
Import submodules directly (e.g. ``from kumi.core.features.prompts.store import ...``) to avoid import cycles
with ``kumi.core.features.config``; this ``__init__`` stays minimal.
"""
...
def __getattr__(name: str):
    ...
    if name in ("compose_messages", "messages_have_multimodal_images"):
        from kumi.core.features.prompts import composer as _composer
