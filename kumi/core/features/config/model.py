"""Pydantic model for ~/.kumi/config.json."""
...
class ModelConfig(BaseModel):
    ...
    # Voice session (mic capture + wake word). Only consulted when `kumi --server --voice` is passed;
    # the modifier sets KUMI_VOICE_ENABLED=1 which the API lifespan watches.
    voice_wake_word: str = "hi kumi"
