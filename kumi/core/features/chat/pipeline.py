...
* ``kumi.core.features.chat.router`` (the HTTP endpoint),
* ``kumi.core.features.proactive.scheduler`` (timer-fired follow-up turns),
...
from kumi.core.platform.runtime.accessors import SESSION_LOCKS
...
async def generate_chat_events(
    ...
    *,
    ...
    importing module (``kumi.core.features.chat.router`` for the HTTP layer).
    """
