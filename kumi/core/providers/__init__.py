...
def create_provider(
    ...
    *,
    ...
    if provider_name == "ollama":
        from kumi.core.providers.ollama_provider import OllamaProvider

        return OllamaProvider()

    if provider_name == "openai":
        from kumi.core.providers.openai_provider import OpenAIProvider
    ...
    if provider_name == "gemini":
        from kumi.core.providers.gemini_provider import GeminiProvider

        return GeminiProvider(api_key=creds["gemini_api_key"])

    if provider_name == "claude":
        from kumi.core.providers.claude_provider import ClaudeProvider
