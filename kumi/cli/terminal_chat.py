...
Available commands:
  ...
  /start_log            Append NDJSON chat traces under ~/.kumi/debug/chat_trace/ (server)
...
def chat_stream(prompt, session_id=DEFAULT_SESSION_ID):
    ...
    headers = connection.auth_headers()
    target_name = "Kumi remote gateway" if connection.mode == "relay" else "Kumi server"
...
if __name__ == "__main__":
    print("Kumi terminal chat started. Type 'exit' or 'q' to quit.")
    print("Type /help for available commands.")
