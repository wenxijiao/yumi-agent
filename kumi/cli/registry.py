"""Command Pattern + registry for the Kumi CLI.

Background
----------
``kumi.cli.main`` used to be a 100-line block of ``if args.server: ... elif
...
OSS commands live in :mod:`kumi.cli.commands`. Enterprise plugins can call
...
class Command(ABC):
    ...
    def validate(self, args: argparse.Namespace) -> str | None:
        ...
        :func:`kumi.cli.commands.validate_cross_command_flags`.
        """
        return None
